...
resource "azurerm_kubernetes_cluster" "cbd_plat_aks_cluster" {
  ...
  kubernetes_version                = "1.32.4"#data.azurerm_kubernetes_service_versions.current.latest_version
  ...
  default_node_pool {
    ...
    orchestrator_version = "1.32.4"#data.azurerm_kubernetes_service_versions.current.latest_version
    zones                = [1, 2, 3]
